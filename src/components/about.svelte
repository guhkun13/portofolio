    ...
    <div class="flex flex-wrap lg:bg-transparent lg:backdrop-blur-md"> 
      <div class="w-full px-4 mb-10 lg:w-1/2">
        ...
        <div id="content" class="flex items-center mt-10">
          ...
          <!-- Github -->
          <a href="https://github.com/guhkun13" target="_blank" class="w-9 h-9 mr-3 rounded-full flex justify-center items-center border border-slate-300 hover:border-primary hover:bg-primary hover:text-white text-secondary">
          ...
          <!-- Gitlab -->
          <a href="https://gitlab.com/guhkun13" target="_blank" class="w-9 h-9 mr-3 rounded-full flex justify-center items-center border border-slate-300 hover:border-primary hover:bg-primary hover:text-white text-secondary">
          ...
          <!-- Facebook -->
          <a href="https://web.facebook.com/guh.kun" target="_blank" class="w-9 h-9 mr-3 rounded-full flex justify-center items-center border border-slate-300 hover:border-primary hover:bg-primary hover:text-white text-secondary">
